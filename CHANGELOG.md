...
### Fixed
- **Dashboard Logs**: Suppressed excessive Flask/Werkzeug request logs (`GET`, `POST`) from the "Live Log" view to keep it clean and focused on actual scanning events.
